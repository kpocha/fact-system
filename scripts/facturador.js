var facturador = {
    ...
    refrescar: function()
    {
        ...
        this.detalle.igv      = (this.detalle.total * 0.21).toFixed(2); // 21 % El IGV y damos formato a 2 deciamles
        //this.detalle.subtotal = (this.detalle.total - this.detalle.igv).toFixed(2); // Total - IGV y formato a 2 decimales
        this.detalle.subtotal    = this.detalle.total.toFixed(2);
        this.detalle.total = ((this.detalle.total*0.21)+this.detalle.total).toFixed(2);
